...
func TestCodeRAGIndexAndSearch(t *testing.T) {
	...
	collection := "coderag-test-" + fmt.Sprintf("%d", time.Now().Unix())
...
Provide a clear, concise answer.`, context3.String(), question3)
	...
	t.Log("\n✓ Test complete - CodeRAG successfully indexed and can retrieve functions/methods semantically")
}
